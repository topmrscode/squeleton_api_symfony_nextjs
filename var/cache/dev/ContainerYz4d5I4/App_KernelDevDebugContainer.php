...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'app.auth.controller' => 'getApp_Auth_ControllerService',
            'app.cart.controller' => 'getApp_Cart_ControllerService',
            'app.product.controller' => 'getApp_Product_ControllerService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_authentication_failure', [0 => function () {
            return ($this->privates['acme_api.event.authentication_failure_listener'] ?? ($this->privates['acme_api.event.authentication_failure_listener'] = new \App\EventListener\AuthenticationListener()));
        }, 1 => 'onAuthenticationFailureResponse'], 0);
        $instance->addListener('lexik_jwt_authentication.on_authentication_success', [0 => function () {
            return ($this->privates['acme_api.event.authentication_success_listener'] ?? ($this->privates['acme_api.event.authentication_success_listener'] = new \App\EventListener\AuthenticationListener()));
        }, 1 => 'onAuthenticationSuccessResponse'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_invalid', [0 => function () {
            return ($this->privates['acme_api.event.jwt_invalid_listener'] ?? ($this->privates['acme_api.event.jwt_invalid_listener'] = new \App\EventListener\JWTListener()));
        }, 1 => 'onJWTInvalid'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_not_found', [0 => function () {
            return ($this->privates['acme_api.event.jwt_notfound_listener'] ?? ($this->privates['acme_api.event.jwt_notfound_listener'] = new \App\EventListener\JWTListener()));
        }, 1 => 'onJWTNotFound'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_expired', [0 => function () {
            return ($this->privates['acme_api.event.jwt_expired_listener'] ?? ($this->privates['acme_api.event.jwt_expired_listener'] = new \App\EventListener\JWTListener()));
        }, 1 => 'onJWTExpired'], 0);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.anonymous.register'] ?? ($this->privates['security.authentication.provider.anonymous.register'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash'))));
            ...
            yield 2 => ($this->privates['security.authentication.provider.guard.main'] ?? $this->load('getSecurity_Authentication_Provider_Guard_MainService'));
            yield 3 => ($this->privates['security.authentication.provider.dao.main'] ?? $this->load('getSecurity_Authentication_Provider_Dao_MainService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.register._indexed_authenticators' => [
            ...
            'lexik_jwt_authentication.pass_phrase' => 'burger_secret',
